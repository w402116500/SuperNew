...
可选配置包括 `MINERU_END_PAGES`、`MINERU_FORCE_OCR`、`MINERU_FORMULA_ENABLE`、`MINERU_TABLE_ENABLE`、`MINERU_IMAGE_ANALYSIS`、`MINERU_EFFORT`、`MINERU_LANGUAGE`、`RERANK_MODEL`、`RERANK_BINDING_HOST`、`RERANK_API_KEY`、`RETRIEVAL_TOP_K`、`AUTO_MERGE_THRESHOLD`。
